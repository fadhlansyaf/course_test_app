...
import 'package:course_test_app/model/model.dart' as _i3;
import 'package:course_test_app/screens/course_page/bloc/course_bloc.dart'
    as _i8;
import 'package:course_test_app/services/api_service.dart' as _i4;
...
class MockApiService extends _i1.Mock implements _i4.ApiService {
  ...
  @override
  _i5.Future<_i3.CourseModel> getCourse() => (super.noSuchMethod(
        Invocation.method(
          #getCourse,
          [],
        ),
  ...
  @override
  _i5.Future<_i6.Uint8List> downloadVideo(
    _i7.Emitter<_i8.CourseState>? emit,
    String? link,
    int? index,
  ) =>
      (super.noSuchMethod(
